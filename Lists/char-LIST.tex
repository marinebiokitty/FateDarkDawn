...
\NEW{PC}{\cBarthomeloi}{
  \s\MYname	{C. Barthomeloi}
  \s\MYfile	{Barthomeloi.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{}
  \MYsex	{\male}
  \s\MYplayer	{}
...
\NEW{PC}{\cEizenberg}{
  \s\MYname	{Izrael Eizenberg}
  \s\MYfile	{Eizenberg.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{}
  \MYsex	{\male}
  \s\MYplayer	{}
